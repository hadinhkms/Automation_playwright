...
- Regression check: `node --test dashboard/services/aiEndpointPolicy.test.js scripts/lib/secretScan.test.js` and `tests/dashboard-api/settings-ai-security.test.js`. Six of its nine tests fail against the previous `aiRoutes.js`.
