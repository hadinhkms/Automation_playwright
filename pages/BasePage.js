...
class BasePage {
   ...
   * (Delegated to mixin — see core/utils/basePageExtensions.js)
   */
...
// Mixins — tách các method chuyên biệt ra file riêng để giữ BasePage dưới 250 dòng
const { applyBasePageExtensions } = require('../core/utils/basePageExtensions');
const { applyVisualRegressionMixin } = require('../core/utils/visualRegression');
applyBasePageExtensions(BasePage);
applyVisualRegressionMixin(BasePage);
